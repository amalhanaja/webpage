...
<section class="relative border-4 border-black overflow-hidden">
	<div class="h-full w-full absolute hidden left-0 -z-10 md:flex md:flex-row">
		...
		>
			<figure class="w-fit relative">
					...
					<defs>
						...
						>
							...
							<feBlend
								...
								result="effect1_dropShadow_1732_179"
							/>
							<feBlend
								mode="normal"
								in="SourceGraphic"
					...
					<defs>
						...
						>
							...
							<feBlend
								mode="normal"
								in2="BackgroundImageFix"
								result="effect1_dropShadow_1732_155"
							/>
							<feBlend
								mode="normal"
								in="SourceGraphic"
				...
				<img
					src={profilePicture}
					alt="Hero"
					class="rounded-t-full border-b-8 object-cover bg-rose-500 border-black border-4 size-120 shadow-xl shadow-black"
				/>
			</figure>
		</div>
	</div>
